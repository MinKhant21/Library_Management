...
export default function Register() {
  ...
  return (
    <div className="w-full max-w-lg mt-16 mx-auto ">
        <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={(e)=>registerForm(e)}>
        <h1 className=' text-2xl text-violet-600 font-semibold'>Register Form</h1>
